...
import com.galgolabs.earthweather.ui.home.NetworkResponse
...
class DashboardViewModel(private var repository: Repository) : ViewModel() {
    ...
    var queryResult: MutableLiveData<NetworkResponse2> = repository.result2
    ...
    fun addDummy(){
        ...
        val c5 = City(id = "sdmfbdj", name = "Old Mombasa", country = "Kenya", lat = -4.0478570900050945, lng = 39.65218390461765)
